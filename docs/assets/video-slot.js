  ...
  class VideoSlot extends HTMLElement {
    connectedCallback() {
      ...
      root.innerHTML = [
        ...
        '.wrap{position:absolute;inset:0;overflow:hidden;background:var(--surface-recessed,#EDF0F3)}',
        ...
        'padding:18px;text-align:center;cursor:pointer;border:1px dashed var(--border-hairline,rgba(0,0,0,.12));',
        "font-family:'Geist Mono',ui-monospace,monospace;font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:var(--text-secondary,#444444)}",
        '.ph:hover,.ph.over{border-color:var(--text-accent,#22D3EE);color:var(--text-accent,#22D3EE)}',
        '.ph b{font-weight:400;color:var(--text-primary,#000000);letter-spacing:.14em}',
        '.hint{font-size:9px;letter-spacing:.14em}',
        '.clear{position:absolute;top:8px;right:8px;z-index:2;background:var(--surface-recessed,#EDF0F3);border:1px solid var(--border-hairline,rgba(0,0,0,.12));',
        "color:var(--text-secondary,#444444);font-family:'Geist Mono',ui-monospace,monospace;font-size:9px;letter-spacing:.16em;text-transform:uppercase;",
        'padding:5px 8px;cursor:pointer;opacity:0;transition:opacity .2s}',
        ':host(:hover) .clear{opacity:1}',
        '.clear:hover{color:var(--text-accent,#22D3EE);border-color:var(--text-accent,#22D3EE)}',
        'input{display:none}',
        '</style>',
        '<div class="wrap">',
